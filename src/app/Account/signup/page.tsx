...
export default function SignupPage() {
  ...
  const fields = [
    ...
    { id: 'gender',       label: 'Gender',            type: 'text',     placeholder: 'Male / Female / Other', autoComplete: 'off' },
    { id: 'password',     label: 'Password',          type: 'password', placeholder: '••••••••',           autoComplete: 'new-password' },
    { id: 'password_conf',label: 'Confirm Password',  type: 'password', placeholder: '••••••••',           autoComplete: 'new-password' },
  ];
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit(signUp)} className="space-y-3.5">
            ...
            <button
              ...
              className="w-full h-11 bg-[#0A0A0A] hover:bg-[#333] disabled:opacity-50 text-white font-bold text-sm rounded-2xl flex items-center justify-center gap-2 transition-all duration-200 mt-1"
            >
              {isSubmitting
