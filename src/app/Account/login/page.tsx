...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#F2F2F2]">
      ...
      {/* ── Right: White form ── */}
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 bg-[#F2F2F2]">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-[#0A0A0A] mb-1 !text-2xl">Sign in</h1>
          <p className="text-black/40 text-sm mb-7">Welcome back — good to see you.</p>

          <form onSubmit={handleSubmit(login)} className="space-y-4">
            {/* Email */}
            <div>
              <label className="text-xs font-semibold text-black/40 uppercase tracking-wider block mb-1.5">Email</label>
              <input
            ...
            {/* Password */}
            <div>
              <label className="text-xs font-semibold text-black/40 uppercase tracking-wider block mb-1.5">Password</label>
              <input
